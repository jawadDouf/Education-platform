...
<body>
      ...
      <form action="/AdminServlet?field=formateurs&op=assign" method="post" id="form_assigning">
        <div class="relative z-0 w-full mb-5">
          ...
          />
            <input  class="invisible" name="invisibleInputForNakedEye" id="invisibleInputForNakedEye" value=""/>
          ...
          %>
          <div class="w-full text-sm font-medium overflow-scroll text-gray-900 bg-white border-gray-200">
            ...
            <li class="block py-2 px-4 my-[1px] hover:bg-gray-200 w-full text-black bg-gray-300 border-b rounded-lg border-gray-200 cursor-pointer" class="promotion">
              ...
              <li class="" id="invisible">
                  <%=promotion.getId()%> <%=promotion.getNom()%> <%=promotion.getSize()%>
              </li>
