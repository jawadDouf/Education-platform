...
<body>
<div id="overlay3" class="bg-[#808080] w-full h-screen absolute cursor-pointer top-0"></div>
<div id="form_container3" class="absolute top-1/4 left-1/3 transform -translate-x-1/3 -translate-y-1/4 mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl z-20">
    <h1 class="text-2xl text-center font-bold mb-8">Update teacher</h1>
    <form id="form" action="/AdminServlet?field=formateurs&op=add" method="post" class="">
        <div class="flex flex-row space-x-4">
            ...
            <div class="relative z-0 w-full">
                ...
                <span class="text-sm text-red-600 hidden" >Time is required</span>
            </div>
        </div>
        <div class="relative z-0 w-full mb-5">
            <input
