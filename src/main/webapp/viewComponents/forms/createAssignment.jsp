                           ...
                           <div class="lg:col-span-2">
                               ...
                               <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                   ...
                                   <div class="md:col-span-2">
                                       ...
                                       <input class="w-full bg-gray-100 text-gray-900 mt-2 p-2 rounded-lg focus:outline-none focus:shadow-outline"
                                              type="date" placeholder="End Date" name="deadline"/>
                                   </div>
                                   ...
                                   <div class="md:col-span-5" id="languages_container">
                                       ...
                                       <input type="text" hidden id="invisible_language_input" name="languages"/>
                                   </div>
                                   <div class="md:col-span-5">
                               ...
                               <div class="md:col-span-4 text-right">
                                   <div class="inline-flex items-end">
                                       <input type="submit" value="Create assignment" class="w-full mt-5 flex justify-center bg-gradient-to-r from-indigo-500 to-blue-600  hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-600 text-gray-100 p-3  rounded-full  font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                                   </div>
                               </div>
                               </form>
                           </div>
