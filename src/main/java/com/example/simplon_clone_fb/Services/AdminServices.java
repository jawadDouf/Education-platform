...
public class AdminServices {
    ...
    //delete actor
    public boolean deleteElement(String actor, String id) {
        if (actor.equalsIgnoreCase("formateurs")) {
            return new daoFormateur().deleteElement(FormateursModel.class, Integer.parseInt(id));
        } else if (actor.equalsIgnoreCase("apprenants")) {
            return new daoApprenant().deleteElement(ApprenantsModel.class, Integer.parseInt(id));
        } else if (actor.equalsIgnoreCase("promotions")) {
            return new daoPromotions().deleteElement(PromotionsModel.class, Integer.parseInt(id));
        }else{
            return false;
        }
    }
